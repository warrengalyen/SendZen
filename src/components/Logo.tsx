    ...
    return (
        <Link href="/">
            <div className={`${justifyContent} align-center flex`}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512.001 512.001">
                    <path d="m102.537 236.375 48.035 234.775L503.831 40.851z" fill="#027372"/>
                    <path d="M251.97 369.49 150.572 471.15l17.267-147.838 64.707 1.77z" fill="#02acab"/>
                    <path d="M503.831 40.851 114.133 293.049 8.17 233.352zM503.831 40.851l-.512 1.427L298.835 395.21l-130.996-71.898z" fill="#81e3e2"/>
                    <path d="M298.835 395.21 503.319 42.278 363.968 430.963z" fill="#42c8c6"/>
